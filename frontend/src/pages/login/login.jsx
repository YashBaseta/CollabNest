      ...
      <div className=" min-h-screen bg-gradient-to-br from-amber-400 to-amber-800">
        ...
        <div className="flex flex-col items-center justify-center mt-20 px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-10 w-full max-w-md">
            <h2 className="text-4xl font-extrabold text-amber-700 mb-3 text-center">
              Login
            </h2>
            ...
            <Button
              onClick={login}
              className="mt-6 w-full bg-amber-700 hover:bg-amber-800 text-white py-2.5 font-semibold rounded-lg transition duration-200 ease-in-out"
            >
              Login
            </Button>
          </div>
