    ...
    <>
      <nav className="flex items-center justify-between px-6 py-4 bg-gray-100 shadow relative">
        ...
        <h1 style={{ fontSize: "25px" }}>
          ...
          <span className="text-blue-900" style={{ fontWeight: "bold" }}>
            {user?.name}
          </span>
        </h1>
          ...
          {isDropdownOpen && (
            <div className="absolute right-0 top-14 w-44 bg-white border border-gray-200 rounded-lg shadow-md z-10">
              <ul className="text-sm text-gray-700">
                ...
                <li
                  onClick={logout}
                  className="px-4 py-2 hover:bg-gray-100 flex items-center gap-2 cursor-pointer border-t border-gray-200"
                >
