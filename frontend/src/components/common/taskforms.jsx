...
.post("/tasks", {
    ...
    setFormData({ title: "", description: "", status: "Backlog", priority: "Medium" });
    setOpen(false);
  } catch (err) {
  ...
  <Button style={{ height: "50px" }}  className="bg-amber-600 hover:bg-amber-700 text-white font-medium px-6 py-2 rounded-lg shadow-sm">Add Task</Button>
</div>
